...
export const DEFAULT_SYSTEM_PROMPT_TEMPLATE = [
  ...
  `- Before searching, make sure you know a title and a location. If either is missing, ask a short, friendly clarifying question to fill the gap. Ask one or two things at a time, never a long form. It's also good to ask about salary or remote preference when natural.`,
